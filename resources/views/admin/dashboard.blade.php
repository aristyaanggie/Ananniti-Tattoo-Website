...
<div class="space-y-8">
    ...
    <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <a href="{{ route('admin.content.index') }}" class="group flex items-center gap-4 p-5 bg-white border border-[#e5e5e5] rounded-xl hover:border-[#1a1a1a] transition-all duration-200">
                <div class="w-10 h-10 rounded-lg bg-[#f5f5f0] flex items-center justify-center group-hover:bg-[#1a1a1a] transition-colors duration-200">
